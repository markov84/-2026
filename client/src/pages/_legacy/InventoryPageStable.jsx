...
export default function InventoryPageStable() {
        ...
        <ResponsiveTable>
          <DataGrid
            ...
            columns={[
              ...
              { field: "reorderLevel", headerName: "Минимална наличност", flex: 0.9, minWidth: 170 },
              { field: "status", headerName: "Статус", flex: 0.9, minWidth: 130, renderCell: (params) => <Chip label={params?.row?.isLowStock ? "Ниска наличност" : "Нормално"} color={params?.row?.isLowStock ? "warning" : "success"} size="small" /> },
              {
                ...
                width: 110,
                align: "center",
                renderCell: (params) => <GridRowActions onEdit={() => openEditDialog(params.row)} onDelete={() => setDeletingItem(params.row)} />
              }
            ]}
